...
Stable horse listings use bounded, anatomy-safe image regions and compact browser-simulation cards rather than collectible-card styling. Every listing exposes identity, all seven abbreviated public stats, restrained Career Points/tier information, and one clear profile action. Cards and dense compact rows share the same component. Stable listings support name search plus breed, sex, age, origin, show-tier, and breeding-eligibility filters, with sorting by identity, age, recency, Career Points, or any stat. Store inventory retains its distinct shopping layout.
