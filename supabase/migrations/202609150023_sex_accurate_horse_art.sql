-- Regenerate every eligible system portrait with explicit sex anatomy.
-- Player-uploaded image URLs remain excluded and cannot be overwritten.
update public.horses h set image_generation_status='pending',image_prompt_version='horse-v6'
