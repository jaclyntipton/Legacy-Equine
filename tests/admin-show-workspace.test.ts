...
const player=readFileSync("app/shows-v2.tsx","utf8"),admin=readFileSync("app/admin-shows.tsx","utf8"),sql=readFileSync("supabase/migrations/202609170004_owner_show_capabilities_admin_workspace.sql","utf8");
