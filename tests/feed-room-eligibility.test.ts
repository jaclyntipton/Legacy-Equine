...
const ui=readFileSync(new URL("../app/stable-inventory.tsx",import.meta.url),"utf8"),sql=readFileSync(new URL("../supabase/migrations/202609180006_feed_room_eligibility_and_bulk_feeding.sql",import.meta.url),"utf8");
